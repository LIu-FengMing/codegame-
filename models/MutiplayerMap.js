...
//創造資料庫需要的欄位(schema)
var mutiPlayerGameMapSchema = mongoose.Schema({
...
var mutiPlayerGameMapRecord = module.exports = mongoose.model('MutiPlayerGameMap', mutiPlayerGameMapSchema)


module.exports.dropDB = function (callback) {
    mutiPlayerGameMapRecord.remove({}, callback);
}
...
module.exports.getMap = function (callback) {
    var query = {};
    mutiPlayerGameMapRecord.find(query, callback)
}

// getMap
module.exports.getMapByLevel = function (levelID, callback) {
    var query = { level: levelID }
    mutiPlayerGameMapRecord.findOne(query, callback)
}
...
module.exports.updateMapByLevel = function (levelID, scriptData, callback) {
    ...
    mutiPlayerGameMapRecord.updateOne(query, setquery, callback);
}
