...
mainDescription = {
  "oblivionObject":[
    ...
    },
    {
      "level":3,
      "mode":1,
      "textarea1":"此為創建&修改關卡頁面，可在此頁面創建&修改屬於自己的關卡。<br><br>可透過上方\"物件選擇選單\"選擇欲新增至地圖的物件，並且可調整物件角度，然後按下\"新增物件\"至地圖指定位置上，也可點擊指定物件後點擊\"刪除物件\"來移除物件。<br>而可放置的物件是依照星星數量來解鎖的。<br>--------星星解鎖物件表--------<br>終點線-3顆星<br>石頭-3顆星<br>樹-3顆星<br>金幣-12顆星<br>藍色鎖頭-15顆星<br>問號標誌-21顆星<br>問號石頭-21顆星<br>黃色鎖頭-39顆星<br>黃色箭頭-39顆星<br>炸彈-45顆星<br>敵人-75顆星<br>地形-81顆星<br>寶箱-120顆星<br>進階-120顆星<br><br>接著可於右方的”關卡設定”設定關卡名稱、關卡簡介、關卡說明。<br><br>然而有些物件(藍色鎖頭、寶箱、敵人)有屬性需進行設定，即可透過點擊地圖上的物件後點擊右方的\"物件屬性\"來進行設定，鎖頭需設定鎖頭解答，敵人需設定血量及攻擊力，而寶箱則需要設定寶箱字串。<br><br>當星星集至81顆後，即會解鎖地圖設置，將可進行調整地圖大小以及地形的配置。<br><br>當星星集至120顆後，即會解鎖進階，將可設定是否開啟迷霧以及使用擴充程式區。"
    },
    {
      "level":4,
      "mode":1,
      "textarea1":"此為創建&修改關卡頁面，可在此頁面創建&修改屬於自己的關卡。<br><br>可透過上方\"物件選擇選單\"選擇欲新增至地圖的物件，並且可調整物件角度，然後按下\"新增物件\"至地圖指定位置上，也可點擊指定物件後點擊\"刪除物件\"來移除物件。<br>而可放置的物件是依照星星數量來解鎖的。<br>--------星星解鎖物件表--------<br>終點線-3顆星<br>石頭-3顆星<br>樹-3顆星<br>金幣-12顆星<br>藍色鎖頭-15顆星<br>問號標誌-21顆星<br>問號石頭-21顆星<br>黃色鎖頭-39顆星<br>黃色箭頭-39顆星<br>炸彈-45顆星<br>敵人-75顆星<br>地形-81顆星<br>寶箱-120顆星<br>進階-120顆星<br><br>接著可於右方的”關卡設定”設定關卡名稱、關卡簡介、關卡說明。<br><br>然而有些物件(藍色鎖頭、寶箱、敵人)有屬性需進行設定，即可透過點擊地圖上的物件後點擊右方的\"物件屬性\"來進行設定，鎖頭需設定鎖頭解答，敵人需設定血量及攻擊力，而寶箱則需要設定寶箱字串。<br><br>可透過右方的\"地圖設置\"，進行調整地圖大小以及地形的配置。<br><br>當星星集至120顆後，即會解鎖進階，將可設定是否開啟迷霧以及使用擴充程式區。"
    },
    {
      "level":5,
      "mode":1,
      "textarea1":"此為創建&修改關卡頁面，可在此頁面創建&修改屬於自己的關卡。<br><br>可透過上方\"物件選擇選單\"選擇欲新增至地圖的物件，並且可調整物件角度，然後按下\"新增物件\"至地圖指定位置上，也可點擊指定物件後點擊\"刪除物件\"來移除物件。<br>而可放置的物件是依照星星數量來解鎖的。<br>--------星星解鎖物件表--------<br>終點線-3顆星<br>石頭-3顆星<br>樹-3顆星<br>金幣-12顆星<br>藍色鎖頭-15顆星<br>問號標誌-21顆星<br>問號石頭-21顆星<br>黃色鎖頭-39顆星<br>黃色箭頭-39顆星<br>炸彈-45顆星<br>敵人-75顆星<br>地形-81顆星<br>寶箱-120顆星<br>進階-120顆星<br><br>接著可於右方的”關卡設定”設定關卡名稱、關卡簡介、關卡說明。<br><br>然而有些物件(藍色鎖頭、寶箱、敵人)有屬性需進行設定，即可透過點擊地圖上的物件後點擊右方的\"物件屬性\"來進行設定，鎖頭需設定鎖頭解答，敵人需設定血量及攻擊力，而寶箱則需要設定寶箱字串。<br><br>可透過右方的\"地圖設置\"，進行調整地圖大小以及地形的配置。<br><br>可透過右方的\"進階\"，設定是否開啟迷霧以及使用擴充程式區，而擴充程式區則是讓創作者可自訂函式於此關卡中。<br><br>自訂函式可以經由創作者發揮想像力，只要符合程式邏輯以及編碼正確，就可以有無限的可能，以下範例提供給創作者參考，皆為創作者設定一個自訂函式讓使用者必須創陣列、字串來使用函式並且經由函式內容取得創作者給的陣列及字串內容。<br><br>void&nbsp&nbspgetKeyArray(int*&nbsp&nbsparr){&nbsp&nbsp&nbsp&nbsp使使用者取得一個一維陣列內容<br>&nbsp&nbsp&nbsp&nbspint&nbsp&nbspi;<br>&nbsp&nbsp&nbsp&nbspint&nbsp&nbspkey[6]={1,5,9,-1,3,10};<br>&nbsp&nbsp&nbsp&nbspfor(i=0;i<6;i++){<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsparr[i]=key[i];<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br>void&nbsp&nbspgetDirection(char*&nbsp&nbsparr){&nbsp&nbsp&nbsp&nbsp使使用者取得一個一維字元陣列內容<br>&nbsp&nbsp&nbsp&nbspint&nbsp&nbspi;<br>&nbsp&nbsp&nbsp&nbspchar&nbspkey[6]={'L','R','R','L','L','R'};<br>&nbsp&nbsp&nbsp&nbspfor(i=0;i<6;i++){<br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsparr[i]=key[i];<br>&nbsp&nbsp&nbsp&nbsp}<br>}<br>void&nbsp&nbspgetKey(int*&nbsp&nbspx,int*&nbsp&nbspy){&nbsp&nbsp&nbsp&nbsp使使用者取得兩個數字<br>&nbsp&nbsp&nbsp&nbspint&nbspi=5,j=10;<br>&nbsp&nbsp&nbsp&nbspx=&i;&nbspy=&j;<br>}<br>void&nbsp&nbspgetString(char*&nbsp&nbspstr){&nbsp&nbsp&nbsp&nbsp使使用者取得一個字串<br>&nbsp&nbsp&nbsp&nbspchar*&nbsp&nbsptmp=\"ABCCCDEDDf\";<br>&nbsp&nbsp&nbsp&nbspstrcpy(str,tmp);&nbsp&nbsp&nbsp&nbspstrcpy複製字串(目標，複製來源);<br>}<br>void&nbsp&nbsp函式名稱(需要的參數型態及在此函式內的名稱){<br>&nbsp&nbsp&nbsp&nbsp函式內容<br>}"
    }
  ]
};
