  ...
  "oblivionObject": [
    {
      "level": 1,
      "mode": 1,
      "textarea1": "歡迎來到失落帝國！<br>在這裡你可以發揮你的無限想像力創造出獨一無二的關卡，也可以遊玩其他使用者創建的關卡。<br><br>每一個關卡都有遊玩條件，達成遊玩條件後即可遊玩關卡。<br><br>完成關卡後可給予關卡評價，評價高的關卡會更加吸引人喔！！<br><br>點擊左下角的\"自訂關卡\"即可看到自己已創建的關卡以及開始創建屬於你的關卡。<br><br>選定欲遊玩的關卡後點擊右下角的\"進入關卡\"即可開始遊玩。<br><br>未遊玩過的關卡為淡藍色。<br>已遊玩過的關卡為淡紫色。"
    },
    {
      "level": 2,
      "mode": 1,
