...
mainDescription = {
  "oblivionObject":[
    ...
    },
    {
      "level": 25,
      "mode": 1,
      "textarea1": "注意！！有奇怪的戰車擋在路上，經過觀察似乎原本是被報廢的載具，但被神秘的病毒駭入後變為極具攻擊性的奇怪載具。<br><br>打不贏的話就去升級武器和護甲吧，達成一定星星數後便可升級。<br><br>可升級次數最高到15次，並且可以無限重置升級，請根據每一關的情況來配置升級點數。<br><br>上吧勇士！擊敗他通過終點！<br><br>小提示：你與神祕載具的攻擊範圍皆為兩格。<br><br>過關條件：<br>3星：3個動作包含3個動作以內<br>2星：4個動作包含4個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 26,
      "mode": 1,
      "textarea1": "出現了好多的神祕載具！！<br><br>請注意自己的血量，看起來沒有辦法正面交鋒。<br><br>找一條更好的路線吧！就算繞比較遠也沒關係。<br><br>過關條件：<br>3星：11個動作包含11個動作以內<br>2星：12個動作包含12個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 27,
      "mode": 1,
    ...
    },
    {
      "level": 29,
      "mode": 1,
      "textarea1": "好像可以正面擊敗神祕載具唷，好好分配一下裝備升級吧！<br><br>過關條件：<br>3星：8個動作包含8個動作以內<br>2星：9個動作包含9個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 30,
      "mode": 1,
      "textarea1": "還記得階梯形狀怎麼走嗎？<br><br>上面那台神祕載具看起來攻擊不到你，就不用去招惹它了。<br>請結合各指令抵達終點吧！<br><br>過關條件：<br>3星：17個動作包含17個動作以內<br>2星：18個動作包含18個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 31,
      "mode": 1,
      "textarea1": "新指令出現了！！！<br>新指令：<br>getKeyArray( )指令，分類於\"函式\"內。<br><br>出現了好多的神秘載具！<br>不過應該不會正面交鋒。<br><br>新增了對陣列的操作。<br><br>鎖頭精靈的問題：<br>請問密碼陣列中數值最大的為多少 ？<br><br>小提示：玩家需要自己宣告整數陣列，而陣列大小為6。<br>可以利用getKeyArray(陣列名稱,陣列大小);來獲得密碼陣列。<br><br>通關條件：<br>3星：18個動作包含18個動作以內<br>2星：19個動作包含19個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 32,
      "mode": 1,
    ...
    },
    {
      "level": 36,
      "mode": 1,
      "textarea1": "迷霧裡出現了敵人！！！<br>方向陣列裡出現了新的符號'F'，'F'代表的是開火的意思，也就是fire( )。<br><br>小提示：<br>請自行宣告一個大小為 17 的字元陣列(方向陣列)與一個大小為17的整數陣列(距離陣列)。<br><br>利用getDistance(整數陣列,陣列大小)以及getDirection(字元陣列,陣列大小)來獲得距離陣列與方向陣列。<br><br>注意：載具的起始方向是錯誤的，請先用方向陣列修正方向。<br><br>通關條件：<br>3星：4個動作包含4個動作以內<br>2星：5個動作包含5個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 37,
      "mode": 1,
      "textarea1": "新指令出現了！！！<br>新指令：<br>getKey()指令，分類於\"函式\"內。<br><br>暫時離開了迷霧森林，道路的盡頭出現了藍色鎖頭精靈。<br>需要利用getKey( )給予2個整數變數的位址，透過函式獲得的兩個整數值是密鑰的關鍵。<br><br>鎖頭精靈問題：<br>請問 2 個密鑰相加的值為多少？<br><br>小提示：請先宣告 2 個整數變數並將這 2 個變數的位址傳入getKey( )函式裡。<br>如：<br>int x,y;<br>getKey(&x,&y);<br>這樣即可將密鑰關鍵存至x,y。<br><br>在C語言裡可以透過&運算子來獲得變數的位址。<br>將兩個整數值填入x及y後即可進行運算。<br><br>通關條件：<br>3星：28個動作包含28個動作以內<br>2星：30個動作包含30個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 38,
      "mode": 1,
      "textarea1": "新物件與新指令出現了！！<br>新指令：<br>getBox( )指令，分類於\"函式\"內。<br>新物件：<br>寶箱<br><br>道路盡頭的鎖頭鑰匙碎片分散在各個寶箱中，請擊敗敵人打開所有寶箱後將碎片拼湊成完整的鑰匙，並利用鑰匙來通關。<br><br>鎖頭精靈問題：<br>請問寶箱內的字串依獲得的順序串接在一起長怎樣？<br><br>小提示：<br>字串就是以'\\0'字元結尾的字元陣列。<br>可以利用<br>#define SIZE 256<br>void main( ){<br>&nbsp&nbsp&nbsp&nbspchar str[SIZE];<br>}<br>的方式將字元陣列宣告成大小為256。<br><br>到達寶箱旁面對寶箱使用getBox(字元陣列名稱);來獲得字串內容，並且可以使用C語言string.h標頭檔裡的strcat(將被串接的字串目標,欲串接的字串來源)來將2個字串接在一起，範例如下：<br>char str[SIZE]=\"abc\";<br>char tmp[SIZE]=\"123\";<br>strcat(str,tmp);<br>printf(\"%s\",str);<br>這段程式碼的輸出：abc123<br><br>通關條件：<br>3星：48個動作包含48個動作以內<br>2星：50個動作包含50個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 39,
      "mode": 1,
    ...
    },
    {
      "level": 46,
      "mode": 1,
      "textarea1": "進入了新大陸，地圖好像變更大了，敵人的防守也變得嚴密。<br>從敵人身上獲得了通關的程式碼，但是不知道程式碼的真偽。<br><br>請玩家檢查獲得的程式碼找出有漏洞的地方並加以修正來解出真正的通關方法。<br><br>藍色鎖頭精靈問題：<br>請問getKey( )指令所獲得的2個值相加為多少？<br><br>小提示：系統所給予的程式碼並非完全正確，請依照關卡要求修改成正確的程式碼。<br><br>通關條件：<br>3星：55個動作包含55個動作以內<br>2星：58個動作包含58個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 47,
      "mode": 1,
      "textarea1": "一次、兩次、三次、四次、五次...<br>數的頭好暈阿！！<br>這一關鎖頭精靈的問題讓人頭好痛，你能找出正確的答案嗎？<br><br>鎖頭精靈問題：<br>請問字串key在getString( )函式獲得的字串中出現幾次？<br><br>小提示：請自行宣告一個空間夠大的字元陣列，並使用getString(陣列名稱)來獲得字串內容，搭配C語言string.h標頭檔裡的strlen(字串名稱);來獲得字串長度。<br><br>可利用迴圈搭配字串長度來找出key出現在獲得的字串裡總共幾次。<br><br>通關條件：<br>3星：53個動作包含53個動作以內<br>2星：56個動作包含56個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 48,
      "mode": 1,
      "textarea1": "撿到了一塊古代石板！！<br>石板上刻著古老的文字，請研究如何將石板上的文字轉換成正確的值。<br><br>鎖頭精靈問題：<br>請問石板上的2個數字相加為多少？<br><br>小提示：請宣告兩個空間夠大的陣列來接取石板上的文字。<br>玩家須透過getString( );來獲得石板上(字串)內容，字串中有2個數字，長度均小於5，以空白字元分割。<br><br>請將字串的值轉換成整數值並相加來獲得鎖頭精靈問題的答案。<br><br>通關條件：<br>3星：73個動作包含73個動作以內<br>2星：76個動作包含76個動作以內<br>1星：滿足過關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！"
    },
    {
      "level": 49,
      "mode": 1,
