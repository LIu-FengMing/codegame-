  ...
  "oblivionObject":[
    {
      ...
      "textarea2":"請在左方程式區使用指令積木組裝你的程式，組裝完成後，按下右上方的開始按鈕，車子就會照著指令行動。<br><br>編寫程式區右上方按鈕名稱及功能依序為<br>開始－執行程式碼<br>刷新遊戲畫面－將遊戲畫面初始化<br>刷新指令及遊戲畫面－刷新指令區及遊戲畫面<br>設定－環境設定<br><br>在計算結果的指令個數時，step( )指令將會被列入計算。<br>小提示：前進一步為拉一塊step積木至Main積木中。<br><br>過關條件：<br>3星：5個動作包含5個動作以內<br>2星：6個動作包含6個動作以內<br>1星：滿足通關條件即可<br><br>Ctrl鍵加方向鍵上下可以調整程式區字體大小唷！",
      "img1":"level1img1.png",
      "img2":"level1img2.png"
    },
    {
